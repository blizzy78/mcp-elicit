...
export type ElicitDateTimeArgs = z.infer<typeof ElicitDateTimeArgsSchema>
...
export async function handleElicitDateTime(
  { requestedDateTimeTitle: title, requestedDateTimeDescription: description, format }: ElicitDateTimeArgs,
