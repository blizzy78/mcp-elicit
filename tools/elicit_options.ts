...
export const ElicitOptionsArgsSchema = z.object({
  ...
  optionNames: z
    ...
    .optional()
    .describe(
      'An optional array of human-readable names for the options. Must match the length and order of options if provided.'
    ),
})

export type ElicitOptionsArgs = z.infer<typeof ElicitOptionsArgsSchema>
...
export async function handleElicitOptions(
  {
    requestedInformationTitle: title,
    requestedInformationDescription: description,
    options,
    optionNames,
  }: ElicitOptionsArgs,
