...
export async function handleElicitBoolean({ question: title, questionDescription: description }, requestElicitation) {
    ...
    }, z.object({ answer: z.any().nullable().optional() }), (content) => (content.answer && typeof content.answer === 'boolean' ? content.answer.toString() : undefined));
}
